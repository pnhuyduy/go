        ...
        webGpu: {
            ...
            supportedAdapters: {
                ...
                highPerformance: {
                    ...
                    limits: {
                        maxBindGroups: string;
                        maxBindGroupsPlusVertexBuffers: string;
                        maxBindingsPerBindGroup: string;
                        maxBufferSize: string;
                        maxColorAttachmentBytesPerSample: string;
                        maxColorAttachments: string;
                        maxComputeInvocationsPerWorkgroup: string;
                        maxComputeWorkgroupSizeX: string;
                        maxComputeWorkgroupSizeY: string;
                        maxComputeWorkgroupSizeZ: string;
                        maxComputeWorkgroupStorageSize: string;
                        maxComputeWorkgroupsPerDimension: string;
                        maxDynamicStorageBuffersPerPipelineLayout: string;
                        maxDynamicUniformBuffersPerPipelineLayout: string;
                        maxInterStageShaderVariables: string;
                        maxSampledTexturesPerShaderStage: string;
                        maxSamplersPerShaderStage: string;
                        maxStorageBufferBindingSize: string;
                        maxStorageBuffersPerShaderStage: string;
                        maxStorageTexturesPerShaderStage: string;
                        maxTextureArrayLayers: string;
                        maxTextureDimension1D: string;
                        maxTextureDimension2D: string;
                        maxTextureDimension3D: string;
                        maxUniformBufferBindingSize: string;
                        maxUniformBuffersPerShaderStage: string;
                        maxVertexAttributes: string;
                        maxVertexBufferArrayStride: string;
                        maxVertexBuffers: string;
                        minStorageBufferOffsetAlignment: string;
                        minUniformBufferOffsetAlignment: string;
                    };
                    textureFormatCapabilities: string[];
                };
            };
        };
    };
...
declare const spawnArgs: (options: ISpawnArgs, payload: IProfile, fingerprint?: Partial<IOptions>, args?: string[]) => string[];
...
declare const randomWebGL: (platform?: TPlatform) => {
    mode: boolean;
    renderer: string;
    vendor: string;
};
...
declare const platformVersion: Record<TPlatform, string>;
declare const platformUAStrings: Record<TPlatform, string>;
declare const platformNavigatorPlatform: Record<TPlatform, string>;
declare const generateChromeBuildNumber: (version: number) => number;
declare const generateUserAgent: (version: number, platform?: TPlatform) => string;

export { type ICheckProxyResult, type IOptions, type IProfile, type IProxy, type IProxyService, type ISpawnArgs, type Nullable, PROXY_SERVICES, type TPlatform, checkProxy, defaultOptions, deviceMemory, extractProxyInfo, generateChromeBuildNumber, generateUserAgent, getNewFingerprint, hwConcurrency, maxTouchPoints, platformNavigatorPlatform, platformUAStrings, platformVersion, randomFloat, randomInt, randomItem, randomUID, randomWebGL, screens, spawnArgs, writePrefs };
